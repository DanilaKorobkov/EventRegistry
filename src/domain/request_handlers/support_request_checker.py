...
class SupportedRequestChecker:

    @classmethod
    def isSupported(cls, request: RequestWrapper):
        ...
        return cls.__isSupportedData(request.get('data'))


    @classmethod
    def __isSupportedData(cls, request: RequestWrapper):
        ...
        if request.get('what') == 'Sessions':
            ...
            isIntervalSupported = cls.__isIntervalSupported(request.get('interval'))
    ...
    @staticmethod
    def __isIntervalSupported(interval: RequestWrapper):
